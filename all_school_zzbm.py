...
def main():
	res = get_url("https://gaokao.chsi.com.cn/zzbm/mdgs/orgs.action?lx=1")
	...
	for x in res:
		if(re.match("subOrgs",x,flags=0) != None):
			...
			print("Find Folder:::")
			tmp = get_url("https://gaokao.chsi.com.cn/zzbm/mdgs/"+str(x)+"&lx=1")
			print("Getting ",len(tmp),"URLs")
			for y in tmp:
				print("Collecting ",y,"==========")
				get_detail("https://gaokao.chsi.com.cn/zzbm/mdgs/"+str(y)+"&lx=1&start=")
		else:
			print("Collecting ",x,"==========")
			get_detail("https://gaokao.chsi.com.cn/zzbm/mdgs/"+str(x)+"&lx=1&start=")
	f.write("</table>")
	print("ALL DONE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
...
'''
res = get_url("https://gaokao.chsi.com.cn/zzbm/mdgs/subOrgs.action?oid=476734760&lx=1")
print("RES:",len(res))
for x in res:
	print(x)
#f.write("<table>\n")
#get_detail("https://gaokao.chsi.com.cn/zzbm/mdgs/"+str(res[3])+"&lx=1&start=")
#f.write("</table>")
'''
